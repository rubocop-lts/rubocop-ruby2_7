...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/ruby2_7/version.rb", mod) }::Rubocop::Ruby27::Version::VERSION
  spec.authors = ["Peter H. Boling"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "🦾 Rules for Rubies: Rubocop + Standard + Betterlint + Gradual"
  spec.description = "🦾 Configure RuboCop + a bevy of friends to gradually lint Ruby 2.7 code"
  spec.homepage = "https://github.com/rubocop-lts/rubocop-ruby2_7"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-ruby2-7.galtzo.com"
  ...
  # Utilities
  spec.add_dependency("rubocop-gradual", "~> 0.3", ">= 0.3.6") # Ruby >= 2.6.0
  ...
  spec.add_dependency("standard-rubocop-lts", "~> 2.0", ">= 2.0.3") # Ruby >= 3.2.0
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.15")     # ruby >= 3.2.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.6")             # ruby >= 3.2.0
  ...
  # The 'git' gem is optional; rubocop-ruby2_7 falls back to shelling out to `git` if it is not present.
  ...
  spec.add_development_dependency("kramdown", "~> 2.5", ">= 2.5.2") # Ruby >= 2.5
  ...
  spec.add_development_dependency("rubocop-lts-rspec", "~> 1.0", ">= 1.0.2") # Ruby >= 3.2.0
